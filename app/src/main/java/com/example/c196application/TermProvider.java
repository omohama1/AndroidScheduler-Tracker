...
public class TermProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.c196application.termprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return database.query(DBOpenHelper.TABLE_TERMS, DBOpenHelper.ALL_TERM_COLUMNS,
                selection, null, null, null,
                DBOpenHelper.TERM_START + " DESC");
    }
